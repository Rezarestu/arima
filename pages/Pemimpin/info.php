                                    ...
                                    <div class="col-xl-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Project Berjalan</h5>
                                                <form class="needs-validation" action="?cat=Admin&page=aksi&act=1" method="POST" novalidate>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Penawaran</h5>
                                                <form class="needs-validation2" action="?cat=Admin&page=aksi_penawaran&act=1" method="POST" novalidate>
												<div class="position-relative form-group">
														<label for="sales" class="">Sales</label>
														<select id="sales" name="sales" class="form-control">
															<option>Nama Sales</option>
