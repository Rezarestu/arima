                                    ...
                                    <div class="col-xl-12">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body"><h5 class="card-title">Input Sales</h5>
                                                <form class="" action="?cat=Pemimpin&page=aksi_sales&act=1" method="POST">
											...
											<div class="card-body"><h5 class="card-title">Daftar Sales</h5>
												...
												<tr>
													...
													<td><a href="?cat=Pemimpin&page=delete&id=<?php echo ($hasil1['id']); ?>" onclick="if (!confirm('Apa Anda Yakin?')) { return false }">Delete</a></td>
												</tr>
													<?php
													}
													?>
